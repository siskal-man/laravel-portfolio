            ...
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    <p class="text-base mb-8 max-w-[520px]">
                        ...
                        <a class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-primary" href="https://youtube.com/TheCodeholic" target="_blank">YouTube Channel</a>. <br>
                    </p>
