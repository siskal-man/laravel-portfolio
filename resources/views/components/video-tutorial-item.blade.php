    ...
    <div class="bg-white rounded-lg mb-10">
        ...
        <section x-data="{
          ...
          url: '',
            ...
            <div class="flex flex-wrap justify-center">
                <div class="w-full aspect-video relative z-20">
                    <div class="w-full h-full absolute top-0 left-0 p-3">
                        <!-- Thumbnail -->
                        <img src="https://i.ytimg.com/vi/{{ $videoId }}/original.jpg" alt="image" class="w-full h-full object-center object-cover rounded-lg" />
                        <!-- /Thumbnail -->
                    </div>
                    <div class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-primary bg-opacity-0 z-10">
                        <!-- Play Video -->
                        <a href="javascript:void(0)" @click="videoOpen = true; url = videoUrl" class="flex items-center justify-center w-20 md:w-[70px] h-20 md:h-[70px] rounded-full bg-white text-primary absolute z-20">
                            <span class="absolute w-full h-full rounded-full top-0 right-0 bg-white bg-opacity-20 z-[-1] animate-ping delay-300 duration-1000"></span>
            ...
            <!-- Video -->
            <div x-show="videoOpen" x-transition class="fixed top-0 left-0 w-full h-screen flex items-center justify-center z-50 bg-black bg-opacity-70">
                ...
                <button @click="videoOpen = false" class="absolute top-0 right-0 w-20 h-20 flex items-center justify-center cursor-pointer text-body-color hover:bg-black">
        ...
        <div class="p-6 xl:p-7 2xl:p-9 h-[320px] overflow-hidden text-center">
            <h3>
                <a href="https://youtu.be/{{ $videoId }}" target="_blank " class="font-bold text-dark text-lg mb-4 block hover:text-primary">
                    {{ $title }}
                </a>
            </h3>
